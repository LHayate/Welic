...
using Permission = Welic.App.Models.Permissions.Permission;
using PermissionStatus = Welic.App.Models.Permissions.PermissionStatus;
    ...
    public class PermissionsService : IPermissionsService
    {
        ...
        bool HasPermissionInManifest(string permission)
        {
            try
            {
                ...
                var context = MainActivity.CurrentContext ?? Application.Context;
