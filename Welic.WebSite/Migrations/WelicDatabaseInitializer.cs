...
{
    public class WelicDatabaseInitializer : DbMigrationsConfiguration<AuthContext>
    {
        ...
        //public WelicDatabaseInitializer(InstallModel installModel)
        //    : base()
        //{
        ...
        //        {
        //            var pathFrom = Path.Combine(System.Web.HttpContext.Current.Server.MapPath("~/Imagens/images/sample/community"), file);
        //            var pathTo = Path.Combine(System.Web.HttpContext.Current.Server.MapPath("~/Imagens/images/community"), file);
        //            File.Copy(pathFrom, pathTo, true);
        //        }
        //    }
        //    else
        ...
        //private void InstallSampleData(AuthContext context, ApplicationUser user)
        //{
