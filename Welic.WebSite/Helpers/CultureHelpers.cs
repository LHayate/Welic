    ...
    public static class CultureHelper
    {
        ...
        { "af", "af-ZA",
          "sq", "sq-AL",
            ...
            "div", "div-MV",
            "nl", "nl-BE", "nl-NL",
            "en", "en-AU", "en-BZ", "en-CA", "en-029", "en-IN", "en-IE", "en-JM", "en-MY", "en-NZ", "en-PH", "en-SG", "en-ZA", "en-TT", "en-GB", "en-US", "en-ZW",
            "et", "et-EE",
            "fo", "fo-FO",
            "fil-PH",
            "fi", "fi-FI",
            ...
            "sma-NO", "sma-SE",
            "sa", "sa-IN",
            "sr", "sr-Cyrl-BA", "sr-Cyrl-SP", "sr-Latn-BA", "sr-Latn-SP",
            "nso-ZA",
            "tn-ZA",
            "si-LK",
            "sk", "sk-SK",
            "sl", "sl-SI",
            "es", "es-AR", "es-BO", "es-CL", "es-CO", "es-CR", "es-DO", "es-EC", "es-SV", "es-GT", "es-HN", "es-MX", "es-NI", "es-PA", "es-PY", "es-PE", "es-PR", "es-ES", "es-US", "es-UY", "es-VE",
            "sv", "sv-FI", "sv-SE",
            "syr", "syr-SY",
            "tg-Cyrl-TJ",
            "tzm-Latn-DZ",
        ...
        private static readonly List<string> _cultures = new List<string> {
            ...
            "es-ES","es-AR", "es-BO", "es-CL", "es-CO", // Spanish NEUTRAL culture
            "ar-AE",  // Arabic NEUTRAL culture          
        };
