...
namespace Welic.WebSite.Areas.Admin.Controllers
{
    ...
    public class InstallController : Controller
    {
        ...
        public ActionResult CheckAndInstall(InstallModel model)
        {
            ...
            var subPaths = new string[] { "~/App_Data", "~/Imagens/images/listing", "~/Imagens/images/profile" };
            ...
            switch ((DatabaseType)model.DatabaseType)
            {
                ...
                default:
                    string databaseFileName = string.Format("Welic_{0}.sdf", DateTime.Now.ToString("yyyy.MM.dd.HH.mm.ss"));
                    string databasePath = @"|DataDirectory|\" + databaseFileName;
                    connectionString = "Data Source=" + databasePath + ";Persist Security Info=False";

                    connectionStringSettings = new ConnectionStringSettings("WelicDbContext", connectionString, "System.Data.SqlServerCe.4.0");
                    break;
                case DatabaseType.MsSqlServer:
                    ...
                    connectionStringSettings = new ConnectionStringSettings("WelicDbContext", connectionString, "System.Data.SqlClient");
