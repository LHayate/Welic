...
namespace Plugin.Payment.Stripe.Controllers
{
    public class PaymentStripeController : Controller, IPaymentController
    {
        ...
        /// </summary>
        /// <returns></returns>
        public ActionResult Payment(Welic.Dominio.Models.Marketplaces.Entityes.Order additionalData)
        {
        ...
        public ActionResult PaymentSetting(string scope, string code)
        {
            if (!string.IsNullOrEmpty(scope) && !string.IsNullOrEmpty(code))
            {
                ...
                var response = client.Execute<Plugin.Payment.Stripe.Data.StripeConnect>(request);
                ...
                if (string.IsNullOrEmpty(response.Data.error))
                {
                    ...
                    response.Data.ObjectState = ObjectState.Added;
            ...
            return View("~/Plugins/Plugin.Payment.Stripe/Views/PaymentSetting.cshtml", StripePlugin.Enum_StripeConnectStatus.None);
        }
