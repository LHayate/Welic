...
{
    public partial class FormAssistenteCadastro : FormWelic
    {
        /// <summary>
        ...
        public virtual void btnNovoRegistro_Click(object sender, EventArgs e)
        {
            if (frmBase != null)
            {
                if (!UsrTemPermissao(_TipoPermissaoCodigoSeguranca.Insert))
                {
        ...
        protected void dgv_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex != -1 && frmBase != null)
            {
                ...
                {
                    if (!UsrTemPermissao(_TipoPermissaoCodigoSeguranca.Read))
                    {
                ...
                {
                    if (!UsrTemPermissao(_TipoPermissaoCodigoSeguranca.Update))
                    {
