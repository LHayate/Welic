...
namespace Welic.WinForm.Cadastros.Estacionamento
{
    public partial class frmSolicitacoesVagas : FormCadastro
    {
        ...
        //        var retorno =
        //            ClienteApi.Instance.ObterResposta<List<SolicitacoesVagasDto>>(response);

        //        if (retorno.Count > 0 )
        //        {
        //            fb = new FormBuscaPaginacao();
        //            fb.SetListAsync<SolicitacoesVagasDto>(retorno, "IdSolicitacao");
        //            fb.ShowDialog();
        //            BindingSolicitacao.DataSource = fb.RetornoList<SolicitacoesVagasDto>();

        //            HttpResponseMessage responseVeic =
        //                ClienteApi.Instance.RequisicaoGet($"Veiculo/get/{fb.RetornoList<SolicitacoesVagasDto>().IdVeiculo}");
        //            var retornoVeic =
        //                ClienteApi.Instance.ObterResposta<VeiculoDto>(response);

        //            if (retornoVeic != null)
        //            {                        
        //                BindingSolicitacao.DataSource = retornoVeic;
        //            }

        //            HttpResponseMessage responsePes =
        //                ClienteApi.Instance.RequisicaoGet($"Veiculo/getByPessoa/{retornoVeic.IdPessoa}");
        //            var retornoPes =
        //                ClienteApi.Instance.ObterResposta<VeiculoDto>(response);
        ...
        //                var retorno =
        //                    ClienteApi.Instance.ObterResposta<SolicitacoesVagasDto>(response);
        ...
        //        dgvEstacionamentosIndicados.DataSource =
        //            new IndicacaoEstacionamento().BuscaIndicacaoEstacionamento(int.Parse(txtSolicitacao.Text));
        //    }
        //}
        ...
        //    HttpResponseMessage response =
        //        ClienteApi.Instance.RequisicaoGet($"pessoa/getbycpf/{mtxtCPF.Text.Replace('-',' ').Replace('.',' ')}");
        //    var retorno =
        //        ClienteApi.Instance.ObterResposta<PessoaDto>(response);

        //    HttpResponseMessage responseVeic =
        //        ClienteApi.Instance.RequisicaoGet($"Veiculo/getByPessoa/{retorno.IdPessoa}");
        //    var retornoVeic =
        //        ClienteApi.Instance.ObterResposta<VeiculoDto>(response);
        ...
        //            var solicitacoesVagasLiberadas = new SolicitacoesVagasLiberadasDto
        //            {
        //                Vaga = linha.Index,
        //                IdEstacionamento = int.Parse(linha.Cells["colEstacionamento"].Value.ToString()),
        //                IdVeiculo = int.Parse(mtxtPlaca.Tag.ToString()),
        //                Manha = int.Parse(linha.Cells["colEstacionamentoManha"].Value.ToString()),
        //                Tarde = int.Parse(linha.Cells["colEstacionamentoTarde"].Value.ToString()),
        //                Noite = int.Parse(linha.Cells["colEstacionamentoNoite"].Value.ToString()),
        //                IdUser = Globals.IdUser,
        //                DtLiberacao = DateTime.Now,
        //                DtValidade = DateTime.Parse(mskDataValidade.Text),
        //                Situacao = 1,     
        //                TipoIdentificacao = 1 //TODO: Criar padrão como 1
        //            };

        //            HttpResponseMessage
        //                response = ClienteApi.Instance.RequisicaoPost("Solicitacoes/saveVagasLiberadas", solicitacoesVagasLiberadas);

        //            solicitacoesVagasLiberadas =
        //                ClienteApi.Instance.ObterResposta<SolicitacoesVagasLiberadasDto>(response);
        ...
        //            HttpResponseMessage responseSolicEstacionamentoGet =
        //                ClienteApi.Instance.RequisicaoGet($"Solicitacoes/GetSolicitacoesEstacionamentoByEstacionamento/{chave1}/{solicitacao}");
        //            var solicitacoesEstacionamento =
        //                ClienteApi.Instance.ObterResposta<SolicitacoesEstacionamentoDto>(responseSolicEstacionamentoGet);

        //            solicitacoesEstacionamento.Situacao = 2;
        //            solicitacoesEstacionamento.Vaga = solicitacoesVagasLiberadas.Vaga;

        //            HttpResponseMessage
        //                responsePostEstacionamento = ClienteApi.Instance.RequisicaoPost("Solicitacoes/SaveEstacionamento", solicitacoesEstacionamento);

        //            solicitacoesEstacionamento =
        //                ClienteApi.Instance.ObterResposta<SolicitacoesEstacionamentoDto>(responsePostEstacionamento);                    
        ...
        //        HttpResponseMessage responseSolicVagasGet =
        //            ClienteApi.Instance.RequisicaoGet($"Solicitacoes/GetById/{solicitacao}");
        //        var solicitacoesVagas =
        //            ClienteApi.Instance.ObterResposta<SolicitacoesVagasDto>(responseSolicVagasGet);

        //        solicitacoesVagas.Situacao = 2; // Situação 2 - Atendida
        //        solicitacoesVagas.DtInicio = DateTime.Now;                                
        ...
        //private DataTable BuscaEstacionamentosSugeridos()
        //{
        //    DataTable dtPeriodos = ((DataTable)dgvContratos.DataSource);
        ...
        //{
        //    DataTable dt = BuscaEstacionamentosSugeridos();
        ...
        //    txtColaborador.TipoCampo = TextBoxWelic.CTipoCampo.Chave;
        ...
        //                    txtColaborador.TipoCampo = TextBoxWelic.CTipoCampo.Normal;
        //                }
