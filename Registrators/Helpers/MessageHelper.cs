...
namespace Registrators.Helpers
{
    public static class MessageHelper
    {
        public static MessageReadStateService MessageReadStateService
        {
            get
            {
                return ContainerManager.GetConfiguredContainer().Resolve<MessageReadStateService>();
            }
        }
        ...
        public static MessageService MessageService
        {
            get
            {
                return ContainerManager.GetConfiguredContainer().Resolve<MessageService>();
            }
        }
        ...
        public static MessageThreadService MessageThreadService
        {
            get
            {
                return ContainerManager.GetConfiguredContainer().Resolve<MessageThreadService>();
            }
        }
        ...
        public static MessageParticipantService MessageParticipantService
        {
            get
            {
                return ContainerManager.GetConfiguredContainer().Resolve<MessageParticipantService>();
            }
        }
